		...
		if (isset($_POST["UMOJN"]))
            {
				...
				fxAgregarBitacora($_SESSION["gsUsuario"], "UMO110A", $_POST["UMOJN"], "", "Borrar", "");
            }
		?>
    	<div class="container">
        	<div id="DivContenido">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<table id="grid" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="false" data-row-select="true" data-keep-selection="true">
							<thead>
								<tr>
									<th data-column-id="DEPARTAMENTO_REL" data-identifier="true" data-align="left">Departamento</th>
									<th data-column-id="NOMBRE_110" data-align="left">Nombre</th>
								</tr>
							</thead>
							<tbody>
							<?php
								$mDatos = fxDevuelveDepartamento(1);
								
								while ($mFila = $mDatos->fetch())
								{
									echo ("<tr>");
									echo ("<td>" . $mFila["DEPARTAMENTO_REL"] . "</td>");
        ...
        $(function() {
			...
			$("#remove").on("click", function() {
                if ($.trim($("#grid").bootgrid("getSelectedRows")) != "")
                {
                    ...
                    $.redirect("gridDepartamentos.php", {UMOJN: codDepartamento}, "POST");
                }
			});
            ...
            $("#edit").on("click", function() {
                ...
                {
                    var codDepartamento = $.trim($("#grid").bootgrid("getSelectedRows"));
                    $.redirect("catDepartamentos.php", {UMOJN: codDepartamento}, "POST");
                }
            });
