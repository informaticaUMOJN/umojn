...
<?php }
	else
	{
		...
		$mbPermisoUsuario = fxPermisoUsuario("catAsignaturas", $mbAgregar, $mbModificar, $mbBorrar, $mbAnular);
				...
				<div class="row">
					<div class="col-md-12">
						...
						<table id="grid" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="false" data-row-select="true" data-keep-selection="true">
							<thead>
								<tr>
									<th data-column-id="ASIGNATURA_REL" data-identifier="true" data-width="15%" data-align="left">Asignatura</th>
									<th data-column-id="NOMBRE_040" data-width="30%" data-align="left">Carrera</th>
									<th data-column-id="CODIGO_060" data-width="15%" data-align="left">Código académico</th>
									<th data-column-id="NOMBRE_060" data-width="40%" data-align="left">Nombre</th>
								</tr>
							</thead>
							<tbody>
							<?php
								$mDatos = fxDevuelveAsignatura(1);
...
<script>
	...
	$(function() {
		...
		$("#append").on("click", function() {
			$.redirect("catAsignaturas.php", "POST");
		});
		...
		$("#remove").on("click", function() {
			if ($.trim($("#grid").bootgrid("getSelectedRows")) != "")
			{
				...
				$.redirect("gridAsignaturas.php", {UMOJN: codCarrera}, "POST");
			}
		});
		...
		$("#edit").on("click", function() {
			...
			{
				var codCarrera = $.trim($("#grid").bootgrid("getSelectedRows"));
				$.redirect("catAsignaturas.php", {UMOJN: codCarrera}, "POST");
			}
		});
