<?php
	...
	$msNombre1, $msNombre2, $msApellido1, $msApellido2, $msGradoAcademico, $mdFechaNac, $msLugarNac, $msPais, $msNacionalidad,
	$mnPeso, $mnTalla, $msTipoSangre, $msCedula, $msSexo, $mnEstadoCivil, $mnHijos, $msTelefono, $msCelular, $msCorreoE,
	$msCorreoI, $msDireccion, $mnMedio, $msEmergencia, $msTelEmergencia, $msCelEmergencia, $mbLaboral, $msOcupacion,
	$mnIngresoMensual, $msCentroTrabajo, $msDireccionTrabajo, $mbOtroIdioma, $msIdioma)
	{
		...
		$msConsulta .= "FECHANAC_250, LUGARNAC_250, PAIS_250, NACIONALIDAD_250, PESO_250, TALLA_250, TIPOSANGRE_250, CEDULA_250, ";
		$msConsulta .= "SEXO_250, ESTADOCIVIL_250, HIJOS_250, TELEFONO_250, CELULAR_250, CORREOE_250, CORREOI_250, DIRECCION_250, MEDIO_250, ";
		$msConsulta .= "EMERGENCIA_250, TEL_EMERGENCIA_250, CEL_EMERGENCIA_250, CONDICIONLABORAL_250, OCUPACION_250, INGRESOMENSUAL_250, ";
		...
		$msNombre1, $msNombre2, $msApellido1, $msApellido2, $msGradoAcademico, $mdFechaNac, $msLugarNac, $msPais, $msNacionalidad,
		$mnPeso, $mnTalla, $msTipoSangre, $msCedula, $msSexo, $mnEstadoCivil, $mnHijos, $msTelefono, $msCelular, $msCorreoE, $msCorreoI,
		$msDireccion, $mnMedio, $msEmergencia, $msTelEmergencia, $msCelEmergencia, $mbLaboral, $msOcupacion, $mnIngresoMensual, $msCentroTrabajo,
		$msDireccionTrabajo, $mbOtroIdioma, $msIdioma]);
		return $msCodigo;
	}
	...
	$msDireccionTrabajo, $mbOtroIdioma, $msIdioma)
	{
		...
		$msConsulta .= "GRADOACADEMICO_250 = ?, FECHANAC_250 = ?, LUGARNAC_250 = ?, PAIS_250 = ?, NACIONALIDAD_250 = ?, PESO_250 = ?, ";
		$msConsulta .= "TALLA_250 = ?, TIPOSANGRE_250 = ?, CEDULA_250 = ?, SEXO_250 = ?, ESTADOCIVIL_250 = ?, HIJOS_250 = ?, TELEFONO_250 = ?, ";
		$msConsulta .= "CELULAR_250 = ?, CORREOE_250 = ?, CORREOI_250 = ?, DIRECCION_250 = ?, MEDIO_250 = ?, EMERGENCIA_250 = ?, TEL_EMERGENCIA_250 = ?, ";
		...
		$msApellido1, $msApellido2, $msGradoAcademico, $mdFechaNac, $msLugarNac, $msPais, $msNacionalidad, $mnPeso, $mnTalla, $msTipoSangre,
		$msCedula, $msSexo,	$mnEstadoCivil, $mnHijos, $msTelefono, $msCelular, $msCorreoE, $msCorreoI, $msDireccion, $mnMedio, $msEmergencia,
	...
	function fxDevuelveEstudiantePos($mbLlenaGrid, $msCodigo = "")
	{
		...
		else
		{
			...
			$msConsulta .= "ANNOACADEMICO_250, CARNET_250, NOMBRE1_250, NOMBRE2_250, APELLIDO1_250, APELLIDO2_250, GRADOACADEMICO_250, ";
			$msConsulta .= "FECHANAC_250, LUGARNAC_250, PAIS_250, NACIONALIDAD_250, PESO_250, TALLA_250, TIPOSANGRE_250, CEDULA_250, SEXO_250, ";
			$msConsulta .= "ESTADOCIVIL_250, HIJOS_250, TELEFONO_250, CELULAR_250, CORREOE_250, CORREOI_250, DIRECCION_250, MEDIO_250, EMERGENCIA_250, ";
