...
<?php }
	else
	{
		...
		$mbPermisoUsuario = fxPermisoUsuario("catClientes", $mbAgregar, $mbModificar, $mbBorrar, $mbAnular);
		...
		if (isset($_POST["UMOJN"]))
            {
				...
				fxAgregarBitacora($_SESSION["gsUsuario"], "UMO220A", $_POST["UMOJN"], "", "Borrar", "");
            }
		?>
    	<div class="container">
        	<div id="DivContenido">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<table id="grid" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="false" data-row-select="true" data-keep-selection="true">
							<thead>
								<tr>
									<th data-column-id="CLIENTE_REL" data-identifier="true" data-align="left" data-width="15%">Cliente</th>
									<th data-column-id="NOMBRES_220" data-align="left" data-width="35%">Nombres</th>
									<th data-column-id="APELLIDOS_220" data-align="left" data-width="35%">Apellidos</th>
									<th data-column-id="TIPOESTUDIO_220" data-align="left" data-width="15%">Estudio</th>
								</tr>
							</thead>
							<tbody>
							<?php
								$mDatos = fxDevuelveCliente(1);
								
								while ($mFila = $mDatos->fetch())
								{
									echo ("<tr>");
									echo ("<td>" . $mFila["CLIENTE_REL"] . "</td>");
									echo ("<td>" . $mFila["NOMBRES_220"] . "</td>");
									echo ("<td>" . $mFila["APELLIDOS_220"] . "</td>");
									echo ("<td>" . $mFila["TIPOESTUDIO_220"] . "</td>");
									echo ("</tr>");
								}
							}
							?>
        ...
        $(function() {
			...
			$("#remove").on("click", function() {
                if ($.trim($("#grid").bootgrid("getSelectedRows")) != "")
                {
                    ...
                    $.redirect("gridClientes.php", {UMOJN: codCliente}, "POST");
                }
			});
            ...
            $("#edit").on("click", function() {
                ...
                {
                    var codCliente = $.trim($("#grid").bootgrid("getSelectedRows"));
                    $.redirect("catClientes.php", {UMOJN: codCliente}, "POST");
                }
            });
