...
<?php 
	...
	else
	{
		...
		$mbPermisoUsuario = fxPermisoUsuario("repEsquela");
    ...
    <div id="DivContenido">
        <div class = "row">
            <div class="col-xs-12 col-md-11">
                <div class="degradado"><strong>Esquela de Calificaciones</strong></div>
            </div>
        </div>

        <div class="row">
            <div class="col-sm-12 offset-sm-none col-md-12 offset-md-1">
                <form id="frmEsquela" name="frmEsquela">
...
function llenaEstudiantes()
{
    ...
    $.ajax({
        url: 'funciones/fxDatosEsquela.php',
        type: 'post',
        data: datos,
        contentType: false,
        processData: false,
...
function imprimir() {
    ...
    else
    {
        ...
        $.redirect("repEsquela.php", {msMatricula: mArrMatricula}, "POST", "_blank");
    }
}
</script>